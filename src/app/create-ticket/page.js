      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-indigo-100 to-purple-200 p-6 sm:p-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 w-full max-w-5xl">
          ...
          <Link href="/create-ticket/90-ball" passHref>
            <div
              className="bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300 ease-in-out transform hover:scale-105 p-6 text-center"
              aria-labelledby="bingo-90-ball-title"
              role="link"
            >
              <h2
                id="bingo-90-ball-title"
              ...
              <button
                className="w-full px-4 py-2 bg-indigo-600 text-white font-semibold rounded-lg"
                aria-label="Create 1-90 Number Bingo Card"
              >
                Start 1-90 Bingo Now
              </button>
            </div>
          </Link>
          ...
          <Link href="/create-ticket/75-ball" passHref>
            <div
              className="bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300 ease-in-out transform hover:scale-105 p-6 text-center"
              aria-labelledby="bingo-75-ball-title"
              role="link"
            >
              <h2
                id="bingo-75-ball-title"
              ...
              <button
                ...
                aria-label="Create 1-75 Number Bingo Card"
              >
                Start 1-75 Bingo Now
              </button>
            </div>
          </Link>

          {/* Blackout Bingo - Optional Section */}
          {/* <Link href="/bingo/blackout" passHref>
            <div
              className="bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300 ease-in-out transform hover:scale-105 p-6 text-center"
              aria-labelledby="bingo-blackout-title"
            >
              <h2
                id="bingo-blackout-title"
              ...
              <button
                ...
                aria-label="Create Blackout Bingo Card"
              >
                Start Blackout Bingo Now
              </button>
            </div>
          </Link> */}

          {/* Speed Bingo - Optional Section */}
          {/* <Link href="/bingo/speed" passHref>
            <div
              className="bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300 ease-in-out transform hover:scale-105 p-6 text-center"
              aria-labelledby="bingo-speed-title"
            >
              <h2
                id="bingo-speed-title"
                className="text-xl font-semibold text-yellow-600 mb-2"
              >
                Speed Bingo
              </h2>
              <p className="text-gray-600 mb-4">
              ...
              <button
                className="w-full px-4 py-2 bg-yellow-600 text-white font-semibold rounded-lg"
                aria-label="Create Speed Bingo Card"
              >
                Start Speed Bingo Now
              </button>
            </div>
          </Link> */}
        </div>
